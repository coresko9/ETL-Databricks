...
file_name = f"UsCovidData{file_name_datetime}.json"

mount_path = f"{blob_mount_us_covid_data_path}{folder_path_date}"
...
covid_base_url = "https://api.covidtracking.com/v1/us/current.json"
response_str = ""
